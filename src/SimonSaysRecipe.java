...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
 		images.put(new Integer(KeyEvent.VK_UP), "arrowup.jpeg");
 		images.put(new Integer(KeyEvent.VK_DOWN), "arrowdown.jpeg");
 		images.put(new Integer(KeyEvent.VK_RIGHT), "arrowright.png");
 		images.put(new Integer(KeyEvent.VK_LEFT), "arrowleft.jpeg");
...
showImage();
	...
	private void showImage() {
  	 ...
  	 //7.frame.add(getNextRandomImage()); //7. rename to the name of your frame
		frame.add(getNextRandomImage());
		frame.setTitle("Siomon Says");
