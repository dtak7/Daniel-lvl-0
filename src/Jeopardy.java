...
public class Jeopardy implements ActionListener {
	...
	private JButton createButton(String dollarAmount) {
		...
		lastButton.setText(dollarAmount);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed==firstButton){
			...
			askQuestion("is the Shiba Inu from China?","no",500);
		...
		if (buttonPressed==secondButton){
			askQuestion("do dogs scare cats away?","no",200);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if (answer.equals(correctAnswer)){
			...
			JOptionPane.showMessageDialog(null, "youʻre correct!!!");
		}
		// Otherwise
			else {
				score=score-prizeMoney;
				JOptionPane.showMessageDialog(null, "incorrect the correct answer is ʻNOʻ");
				updateScore();
			}
...
public void playJeopardyTheme() {
	...
	private void updateScore() {
		scoreBox.setText("prizeMoney" + score);
	}
